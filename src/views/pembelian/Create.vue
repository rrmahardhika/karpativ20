    ...
    <v-container style="padding:40px" justify-center fluid>
      <v-layout mb-5>
        <v-flex class="pl-5 ml-1">
          <div class="myTitle">Entri Pembelian</div>
          <div class="breadcums">
          ...
          <v-layout wrap mb-2 style="font-size:14px;">
            ...
            <v-flex sm8 xs12>
              <v-menu
                ...
                :return-value.sync="newData.tgl_pembelian"
              ...
              >
                ...
                <v-date-picker
                  v-model="newData.tgl_pembelian"
                  locale="id-id"
                  color="rgba(255,101,57,1)"
                  scrollable
                  @change="$refs.menu_tanggal.save(newData.tgl_pembelian);"
                ></v-date-picker>
              </v-menu>
            </v-flex>
          </v-layout>
          <v-layout wrap mb-2 style="font-size:14px;">
            ...
            <v-flex sm6 xs12>
              <v-autocomplete
                ...
                class="mySelect"
                v-on:change="getItemJualChoice(newData.id_supplier)"
            ...
            <template v-slot:body.append="{ }">
              <tr>
                <td colspan="4" class="myTitle" style="font-size:20px;">
                  <v-flex pt-4>TOTAL PEMBELIAN</v-flex>
                </td>
                <td
                  colspan="1"
...
export default {
  ...
  methods: {
    ...
    updatePriceOnProduct(index) {
      ...
      this.items[index].harga_satuan = objItemJual.harga_beli;
    },
    initNew() {
      this.newData = {
        no_pembelian:'',
    ...
    saveData() {
      this.newData.item_pembelian=this.items;
      pembelianService
        .post(this.newData)
        .then(() => {
