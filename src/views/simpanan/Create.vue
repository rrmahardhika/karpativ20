    ...
    <v-container style="padding:40px" justify-center fluid>
      <v-layout mb-5>
        <v-flex class="pl-5 ml-1">
          <div class="myTitle">Entri Simpanan</div>
          <div class="breadcums">
          ...
          <v-layout wrap mb-2 style="font-size:14px;">
            ...
            <v-flex sm4 xs12>
              <v-menu
                ...
                :return-value.sync="newData.tgl_simpanan"
              ...
              >
                ...
                <v-date-picker
                  v-model="newData.tgl_simpanan"
                  locale="id-id"
                  color="rgba(255,101,57,1)"
                  scrollable
                  @change="$refs.menu_tanggal.save(newData.tgl_simpanan);"
                ></v-date-picker>
              </v-menu>
            </v-flex>
          </v-layout>
...
export default {
  ...
  computed: {
    computed_tanggal() {
      return this.newData.tgl_simpanan
        ? moment(this.newData.tgl_simpanan).format("DD MMMM YYYY")
        : "";
    }
  },
  methods: {
